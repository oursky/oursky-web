---
title: "Is There a Programming Language to Rule Them All?"
...
The [TIOBE Community Index](https://www.tiobe.com/tiobe-index/), [Institute of Electrical and Electronics Engineers](https://spectrum.ieee.org/at-work/tech-careers/top-programming-language-2020), [RedMonk](https://redmonk.com/sogrady/2020/07/27/language-rankings-6-20/), [Github](https://octoverse.github.com/), and [Stack Overflow](https://insights.stackoverflow.com/survey/2020#technology) have their staples: Python, Java, JavaScript, PHP, C#, C++, and TypeScript, to name a few. There’s the occasional flavors of the month that bounce up to the top 20s, like [R](https://www.zdnet.com/article/programming-language-rankings-r-makes-a-comeback-but-theres-debate-about-its-rise/), Rust, and Kotlin.
...
The most popular doesn’t necessarily translate to the most liked either. Rust is getting love from many developers worldwide — so much so that it even gained nods of approval from [Linux](https://lore.kernel.org/lkml/CAKwvOdmuYc8rW_H4aQG4DsJzho=F+djd68fp7mzmBp3-wY--Uw@mail.gmail.com/T/#u) and [Microsoft](https://www.zdnet.com/article/microsoft-heres-why-we-love-programming-language-rust-and-kicked-off-project-verona/) — but it’s still nowhere near the top 10 (not yet at least). Even [COBOL](https://www.salon.com/2020/04/14/why-covid-19-has-created-demand-for-coders-who-know-a-60-year-old-programming-language/) — a 60-year old language that built [43%](http://fingfx.thomsonreuters.com/gfx/rngs/USA-BANKS-COBOL/010040KH18J/index.html) of banking systems in the U.S. — is recently getting in the good graces of IT teams to address urgent business needs in the time of COVID-19. The same can be said with niche languages like [R](https://www.zdnet.com/article/programming-language-rankings-r-makes-a-comeback-but-theres-debate-about-its-rise/), which is increasingly finding its way to universities to help with finding a vaccine for the coronavirus.

Their surge in popularity is also driven by current demands and strategic push from vendors themselves. More and more are [gravitating](https://www.jetbrains.com/lp/python-developers-survey-2019/) to Python for data analysis, artificial intelligence (AI), and machine learning projects. Kotlin’s steady increase in usage, meanwhile, can be arguably credited to Google’s [endorsement](https://techcrunch.com/2019/05/07/kotlin-is-now-googles-preferred-language-for-android-app-development/).
...
I like languages with sensible defaults. They help reduce conflicts, like how Go has [gofmt](https://golang.org/cmd/gofmt/). Development communities are very much aligned in keeping their projects up to spec, and healthy ecosystems make it possible. For example, Python has the [Zen of Python/PEP 20](https://www.python.org/dev/peps/pep-0020/) that glues developers together by encouraging them to follow its guiding design principles.
...
_Oursky is an engineer-led and DevSecOps-enabled agency comprising a diverse and socially progressive team of experts collaborating across different parts of the world. Ourskyers are technology-oriented who value craftsmanship. Our mission is to create open-source solutions to help enterprises in digital transformation and support developers in building secure and privacy-aware software. We are self-funded, ensuring our engineering culture and excellence are built into our digital products._

_Our accomplished developers have become part of the successes of the startups and enterprises we’ve partnered with._ [_Schedule a no-commitment consultation with us_](https://oursky.com/contact) _and we can explore how to creatively use the right tools for the job._
