---
title: "You’ve got a product. Do you have these 12 essentials?"
...
![startup product development pablo buffer](/images/blogs/2145fc2d15_67994a3ca96b779450bf319e_pablo-22.webp)
...
Focusing on the customer is also directly related to conversion. By engaging with your early customers, you have a better sense of what attracted them to your product. We also learned more about our early users when we were doing A/B tests on our site and realised that they generally knew what the product. That, in turn, taught us to [refine our landing pages](http://blog.oursky.com/2016/06/10/got-37-conversion-first-ab-test/) and product design to suit the needs of future customers.

## Design Isn’t Optional

![shotbot preview images](/images/blogs/d47017b57f_67994a3c93bdb1ce79f4b601_shotbot-preview-images.webp)

Samples of colour themes in our Shotbot app.

Your app’s colour scheme isn’t a detail to rip off the web – it is an integral part of your product identity (Check this [colour theory post](http://blog.logodesignguru.com/color-psychology-guide-to-branding-for-startups/).) Design isn’t just colours. Design includes user experience, hence the term UX designer. Good design places the right features in the right places for a user to navigate seamlessly.
...
With all the free tools out there today, don’t try to build things from scratch. Of course, it might look exactly the way you want if you build everything, but there’s a reason successful tech firms use tools like [Heroku](https://www.heroku.com/). Bloggers use [Buffer’s Pablo](https://pablo.buffer.com/) for visuals, social media experts use [Mailchimp](http://mailchimp.com/), just as a few examples. What developer doesn’t use [Github](https://github.com/)? Do yourself a favour and see what other tools are already available. By the way, check out our new opensource backend development kit, [Skygear](https://skygear.io/).

## Build the Right Team

![Team Talent Management Pablo Buffer](/images/blogs/a2d5e52d2c_67994a3c974cebaa3edd8980_pablo-23.webp)
...
If you’ve developed a runaway hit, perhaps it’s time to focus on that one product. Since you’re in the tech startup world, the equivalent to a business MBA is a prestigious accelerator program. A good accelerator offers access to hands-on mentoring from experienced founders and investors. Accelerators come in many different types, but there’s bound to be one that suits your business needs. For example, if you are in tech B2B, Hong Kong’s [Swire Blueprint accelerator](http://blueprint.swireproperties.com/en/accelerator1.aspx) is great at referring relevant potential clients. For hardware startups, [HAX](https://hax.co/) is one of the largest in the industry.

Accelerators provide a peer network, industry connections, and, of course, access to potential funders. Companies such as AirBnB, Dropbox, Heroku, Wufoo, and Reddit all came from [Y-Combinator](https://www.ycombinator.com/), perhaps the startup equivalent to Harvard’s MBA.

## Products Don’t Always Need Funding

![money pixelbay buffer pablo](/images/blogs/9be6dc05fe_67994a3cba8a39e39eb91ebd_pablo-24.webp)
