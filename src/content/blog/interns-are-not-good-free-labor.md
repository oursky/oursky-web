---
title: "Interns Are Not Good Free Labor"
...
## Here’s a short list of some of our content team’s assumptions before they got interns:

*   Messages are responded to within 24-hours on a business day
*   Messages are acknowledged (i.e. a response back with a noted)
*   The relevant people are cc’d
*   Giving proper (minimum 2-week) notices
*   Spellchecking
*   Proper e-mail formatting
*   Being able to take something and “run with it”
*   Research terms you don’t know
*   Asking for clarification (rather than not doing something, and saying they didn’t get it the next meeting)
*   Knowing how to tag-team and leave comments on the same document
*   Checking off / notifying people about completed tasks with dependencies

These things may sound like common sense, but they clearly weren’t to whomever didn’t do them. Many of them I learned on the job after I founded [Oursky](https://oursky.com/) 9 years ago.
...
Nearly a year after hiring our first part-time content team member, we now have 20 pieces in the content pipeline per month compared to the 4–6 our first part-time writer did.
...
Our editorial team still continues to write, but our staff can now focus on higher-level strategy as well. They also devote the time they used to spend to writing to giving quality feedback for our interns to not only improve their pieces, but their decision making and strategies to tackle writing new topics.
...
If we don’t pay, the indirect message is that we have _chosen not to compensate them, and don’t value them_. As a result, it would make sense for our unpaid intern to go for the next paid project that came around rather than stay with our company.
...
And does that mean interns shouldn’t do grunt work? _No._ Our company has a flat structure. Any intern can contribute ideas to a project that are judged on their own merit, our full-time staff and partners are also just as likely to do lunch take-out runs.
...
And lastly, interns can blow you away with their experience and performance. One of Oursky’s interns [got a 37% download conversion when he was tasked with A/B testing our Shotbot site](https://blog.oursky.com/2016/06/29/ab-4-test-mistakes-got-37-conversio/), and another developed a Go demo game when he was writing documentation for our open-source serverless platform, [Skygear.io](https://skygear.io/).

Another former intern specializes in hardware and was already contributing to [ClosjureScript](https://m.oursky.com/why-i-chose-clojure-over-javascript-24f045daab7e) as a student and one of our content interns had [10k followers and was a paid influencer](https://byrslf.co/why-i-walked-away-from-social-media-after-10-000-followers-53d3267ff8e3).
...
Training and cultural adjustment take time for new recruits, even experienced ones. Oursky’s flexible working hours, open-office, flat team structure, and self-management system may not fit everyone.
...
Not only have our interns contributed monthly pieces, they have freed up our staff to do more integrated content campaigns. There’s a place for everyone to grow in the workplace as long as the role is designed for them to succeed and, in the process, contribute to the company.
