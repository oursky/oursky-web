...
We use [Quip](https://www.quip.com/) to do transparent company documentation on everything from our salary calculator, to our project timelines and guidelines.
...
Oursky is a Hong Kong-based development company that has developed award-winning web and mobile apps for 7 years. We’re inspired by companies like Buffer that champion transparency, so we’re also sharing our best practices, tools and tips too! Our latest project is an open-source BaaS product called [Skygear](http://www.skygear.io/). Take a swing for free!
